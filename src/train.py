...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False):
    ...
    # Learning rate scheduler: it reduces the learning rate when the validation loss reaches a plateau
    # HINT: look here:
    # https://pytorch.org/docs/stable/optim.html#how-to-adjust-learning-rate
    scheduler  = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer,"min",threshold=0.01,verbose=True)
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if valid_loss_min is None or (
            ...
            torch.save(optimizer.state_dict(),"checkpoints/best_val_opt.pt")
